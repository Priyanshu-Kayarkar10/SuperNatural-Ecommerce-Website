      ...
      >
        ...
        {isDropDownActive && (
          <div className="relative px-8 h-full">
            ...
            <ul
              className={`absolute h-full pb-[11rem] w-full flex flex-col px-[3.7rem] text-[1.6rem] leading-[3rem] justify-center transition-transform transform ease-in-out delay-100 duration-300  ${
